        ...
        <div className="container mx-auto">
          <div className="flex m-24 p-12 bg-white shadow ring-2 ring-red-100">
            ...
            <div className="ml-20">
              ...
              <div id="skills" className="flex p-2 space-x-24">
          ...
          <div className="flex m-24 mt-8 p-12 bg-white shadow ring-2 ring-red-100">
            <div>
              ...
              <ul>
                <li>
                  - I'm most famillar with web development using MERN Stack.
                </li>
                <li>
                  - I know how to make REST API application and microservices
                  application.
                </li>
              </ul>
              ...
              <ul>
                <li>
                  - I'm learing Elixir to bring the power of Erlang VM to make
                  concurrency based application.
                </li>
                <li id="projects">
            ...
            <div>
              ...
              <ul className="flex flex-col space-y-2">
                ...
                <li>
                  ...
                  back-end, React for front-end, PostgreSQL for database and Go
                  as REST API service for mining.
                </li>
                </a>
                <a target="_blank" className="text-blue-600" href="https://github.com/tchanhtinh/robot">
                <li>
                ...
                <a target="_blank" className="text-blue-600" href="https://github.com/pystardust/ytfzf">
                <li>
                  - Mar 24 2021 (Contribute): ytfzf, work as a contributor for
                  ytfzf project, POSIX script that helps you find Youtube video
                  on CLI.
                </li>
                </a>
              </ul>
              <div>
                <p className="font-bold mt-4">Live2D Projects</p>
